...
document.addEventListener('swac_ready', function () {
    ...
    let checkFuncs = ['func_objectmap','func_datavisualisation','func_datamap','func_objectscheme','func_dataapi','func_mediagalery','func_mediaupload'];
    for (let curCheckFunc of checkFuncs) {
        // chek if func_mediaupload is active
        window.swac.Model.load({
            fromName: 'tbl_systemconfiguration', // Name of the datatable
            fromWheres: {
